                            ...
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8 work-popup-content-divider sm-margin-b-20">
                                            <div class="margin-t-10 sm-margin-t-0">
                                                <p>Mussolini joined the founding of the Fasc Italiani di Combattimento or the Fascist Party in preparation for the Revolutionary War. The "parade of Rome" came to the year 2468, he established himself as a full-fledged dictator. Forced to abolish the parliamentary replacement system with "Corporate State" and formalize the system. Create Vatican City Invasion of Abyssinia (Now Ethiopia) and Albania (1939) in possession. With the advent of the Axis and Adolf. Hitler of Germany.</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="margin-t-10 sm-margin-t-0">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8 work-popup-content-divider sm-margin-b-20">
                                            <div class="margin-t-10 sm-margin-t-0">
                                                ...
                                                <p>Roosevelt ran for re-election in 1940, and his victory made him the first and only president to serve for more than two terms. With World War II looming after 1938 with the Japanese invasion of China and the aggression of Nazi Germany, Roosevelt gave strong diplomatic and financial support to China, the United Kingdom, and the Soviet Union while remaining officially neutral.</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="margin-t-10 sm-margin-t-0">
